...
const Main = ({ sidebar, setSidebar }) => {
    return (
        <div className='w-full h-screen flex flex-col border-l border-l-gray-400 custom-scrollbar'>
            ...
            <div className='h-full overflow-y-auto flex flex-col gap-5 p-3 custom-scrollbar'>
            ...
            <div className='h-15 bg-gray-400/30 dark:bg-slate-900/50 flex gap-5 items-center p-3'>
                <input type="text" className='outline-none w-full text-xl' placeholder='Type a message...'/>
                <button className='bg-gray-400 dark:bg-slate-800 p-2 rounded-2xl active:scale-90 hover:bg-slate-800/60 cursor-pointer'><IoIosSend className='text-3xl'/></button>
            </div>
        </div>
    )
}
